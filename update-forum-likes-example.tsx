// EXEMPLE D'UTILISATION - À intégrer dans vos composants de forum existants

import React from 'react';
import { LikeButton } from '@/components/LikeButton';

// 1. Dans votre composant ForumTopic (app/student/forum/page.tsx)
// Remplacez l'ancien système de likes par :
...
// 4. Dans votre page principale de forum
export default function StudentForumPage() {
  ...
  // Utiliser les composants avec le token
  return (
...
// 5. Migration des anciennes fonctions handleLike
// AVANT :
...
// APRÈS :
// Plus besoin de ces fonctions ! Le composant LikeButton gère tout :
// - Toggle like/unlike
// - Optimistic updates
// - Gestion des erreurs
// - Contrainte "un like par utilisateur"

// 6. Mise à jour des types TypeScript
interface ForumTopic {
  ...
  content: string;
  tags?: string;
  likes_count: number; // Nouveau champ
  is_pinned: boolean;
  created_at: string;
}
